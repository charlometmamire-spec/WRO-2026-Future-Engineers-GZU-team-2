...
* **Team Name:** [TEAM2
* **Category:** World Robot Olympiad (WRO) Future Engineers 2026[cite: 3]
* **Age Division or Senior (19–22)][cite: 3]
(Optional)][cite: 3, 6]
...
* **Base Platform:** Modified ACEBOTT QD001 chassis platform.
* **Dimensions:** Fits strictly within the maximum allowed boundary of $300\text{ mm} \times 200\text{ mm} \times 300\text{ mm}$[cite: 6].
